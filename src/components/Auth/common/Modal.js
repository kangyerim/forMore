...
const Modal = ({ title, body, onHandleCancel, onHandleSubmit }) => {
					...
					<div className="fmt-3 text-center">
						...
						{onHandleCancel && (
							<div className="items-center px-4 py-3">
								{" "}
								<button className="px-4 py-2 bg-gray-500 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300">
									onHandleCancel
								</button>
							</div>
						)}
