			...
			<form className="relative mt-16">
				...
				<div className="flex justify-around">
					{TagColor.map((tag) => {
						return (
							<div key={tag.code}>
								<input type="radio" id={tag.code} ref={tagColorRef} className="" />
				...
				<div>
					...
					<input id="focusTime" type="number" min="10" max="60" step="5" className="text-9xl" ref={focusTimeRef} />
					<label htmlFor="restTime" className="absolute">
						RestTime
					</label>
					<input id="restTime" type="number" min="10" max="60" step="5" className="text-9xl" ref={restTimeRef} />
				</div>
